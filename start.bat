@ECHO off
rem set DEMO_APP_SIGNATURE_CERT_PRIVATE_KEY=./ssl/stg-demoapp-client-privatekey-2018.pem
rem set MYINFO_SIGNATURE_CERT_PUBLIC_CERT=./ssl/staging_myinfo_public_cert.cer
set DEMO_APP_SIGNATURE_CERT_PRIVATE_KEY=./ssl/stg-swgsolution-client-privatekey.pem
set MYINFO_SIGNATURE_CERT_PUBLIC_CERT=./ssl/staging_myinfo_public_cert.cer

rem set MYINFO_APP_CLIENT_ID=STG2-MYINFO-SELF-TEST
rem set MYINFO_APP_CLIENT_SECRET=44d953c796cccebcec9bdc826852857ab412fbe2
set MYINFO_APP_CLIENT_ID=STG-202000046E-ISOLUTIONS-VEHICLELOANAPPLN
set MYINFO_APP_CLIENT_SECRET=HjXxk6KgCm0Uupj5zl8jEKvPQNCMMx4r
